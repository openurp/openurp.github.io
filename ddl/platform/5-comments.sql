...
comment on column bulletin.docs.begin_on is '生效日期';
comment on column bulletin.docs.domain_id is '业务领域ID';
comment on column bulletin.docs.end_on is '失效日期';
...
comment on column bulletin.notices.domain_id is '业务领域ID';
...
comment on column cfg.apps.app_type is '应用类型';
...
comment on column cfg.data_sources.password is '密码';
comment on column cfg.data_sources.remark is '备注';
comment on column cfg.data_sources.username is '用户名';
