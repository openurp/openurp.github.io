comment on column blob.blob_metas.id is '非业务主键:datetime';
comment on column blob.blob_metas.media_type is 'mediaType?';
comment on column blob.blob_metas.name is 'name?';
comment on column blob.blob_metas.owner is 'owner?';
comment on column blob.blob_metas.path is 'path?';
comment on column blob.blob_metas.profile_id is 'Profile?ID';
comment on column blob.blob_metas.sha is 'sha?';
comment on column blob.blob_metas.size is 'size?';
comment on column blob.blob_metas.updated_at is '更新时间';
comment on column blob.profiles.id is '非业务主键:auto_increment';
comment on column blob.profiles.name is '名称';
comment on column blob.profiles.named_by_sha is 'namedBySha?';
comment on column blob.profiles.path is 'path?';
comment on column blob.profiles.public_download is 'publicDownload?';
comment on column blob.profiles.public_list is 'publicList?';
comment on column blob.profiles.users is 'users?';
...
comment on column bulletin.docs.path is '路径';
comment on column bulletin.docs.size is 'size?';
...
comment on column bulletin.sensitive_words.content is 'content?';
...
comment on column cfg.dbs_properties.value is 'value';
...
comment on column session.session_configs.capacity is 'capacity?';
comment on column session.session_configs.category_id is '用户类别ID';
comment on column session.session_configs.check_capacity is 'checkCapacity?';
comment on column session.session_configs.check_concurrent is 'checkConcurrent?';
comment on column session.session_configs.concurrent is 'concurrent?';
comment on column session.session_configs.id is '非业务主键:auto_increment';
comment on column session.session_configs.tti_minutes is 'ttiMinutes?';
comment on column session.session_events.detail is 'detail?';
comment on column session.session_events.event_type is 'eventType?';
comment on column session.session_events.id is '非业务主键:auto_increment';
comment on column session.session_events.ip is 'ip?';
comment on column session.session_events.name is '名称';
comment on column session.session_events.principal is 'principal?';
comment on column session.session_events.updated_at is '更新时间';
comment on column session.session_events.username is 'username?';
comment on column usr.avatars.file_name is '文件名';
comment on column usr.avatars.id is '非业务主键:assigned';
comment on column usr.avatars.path is 'path?';
comment on column usr.avatars.updated_at is '更新时间';
comment on column usr.avatars.user_id is '用户ID';
comment on column usr.credentials.expired_on is 'expiredOn?';
comment on column usr.credentials.id is '非业务主键:auto_increment';
comment on column usr.credentials.inactive_on is 'inactiveOn?';
comment on column usr.credentials.password is 'password?';
comment on column usr.credentials.updated_at is '更新时间';
comment on column usr.credentials.user_id is '用户ID';
...
comment on column usr.password_configs.dcredit is 'dcredit?';
comment on column usr.password_configs.id is '非业务主键:auto_increment';
comment on column usr.password_configs.idledays is 'idledays?';
comment on column usr.password_configs.lcredit is 'lcredit?';
comment on column usr.password_configs.maxdays is 'maxdays?';
comment on column usr.password_configs.maxlen is 'maxlen?';
comment on column usr.password_configs.minclass is 'minclass?';
comment on column usr.password_configs.mindays is 'mindays?';
comment on column usr.password_configs.minlen is 'minlen?';
comment on column usr.password_configs.ocredit is 'ocredit?';
comment on column usr.password_configs.ucredit is 'ucredit?';
comment on column usr.password_configs.usercheck is 'usercheck?';
comment on column usr.password_configs.warnage is 'warnage?';
...
comment on table blob.blob_metas is 'BlobMeta?';
comment on table blob.profiles is 'Profile?';
comment on table bulletin.docs is '文档';
comment on table bulletin.docs_user_categories is 'userCategories?';
...
comment on table bulletin.notices_user_categories is 'userCategories?';
comment on table bulletin.sensitive_words is 'SensitiveWord?';
...
comment on table cfg.dbs_properties is 'properties?';
...
comment on table session.session_configs is '会话配置';
comment on table session.session_events is '会话日志';
comment on table usr.avatars is '头像';
comment on table usr.credentials is 'Credential?';
...
comment on table usr.password_configs is 'PasswordConfig?';
