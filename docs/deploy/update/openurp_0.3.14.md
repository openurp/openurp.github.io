...
* Platform 升级
  ...
  - 则执行[0.2.29_0.2.31.sql](/docs/model/ddl/platform/migrate/0.2.29_0.2.31.sql)
  - 或查看[所有sql](/docs/model/ddl/index.html)
...
* Openurp 升级
  ...
  - 执行[0.11.0_0.12.0.sql](/docs/model/ddl/openurp/migrate/0.11.0_0.12.0.sql)
