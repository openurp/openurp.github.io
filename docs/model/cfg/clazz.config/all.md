...
<tr><td class="text-center">5</td><td>setting_id</td><td>bigint</td><td class="text-center">否</td><td>课程安排设置ID</td><td>            <a href="/docs/model/cfg/clazz.config/all.html#表格-edu_schedule_settings-课程安排设置">cfg.edu_schedule_settings</a>
</td>  </tr>
</table>
<ul>
  <li>表格的索引</li>
