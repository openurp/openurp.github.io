...
<tr><td class="text-center">5</td><td>extern_student_id</td><td>bigint</td><td class="text-center">否</td><td>外校学习经历ID</td><td>            <a href="/docs/model/base/std/core.html#表格-extern_students-外校学习经历">base.extern_students</a>
</td>  </tr>
...
<tr><td class="text-center">2</td><td>extern_grade_id</td><td>bigint</td><td class="text-center">否</td><td>校外成绩ID</td><td>            <a href="/docs/model/edu/extern/extern.html#表格-extern_grades-校外成绩">edu.extern_grades</a>
</td>  </tr>
</table>
<ul>
  <li>表格的索引</li>
