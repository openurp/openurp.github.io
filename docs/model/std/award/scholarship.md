...
<tr><td class="text-center">4</td><td>category_id</td><td>integer</td><td class="text-center">否</td><td>奖学金种类ID</td><td>            <a href="/docs/model/std/award/scholarship.html#表格-scholarship_categories-奖学金种类">std.scholarship_categories</a>
</td>  </tr>
<tr><td class="text-center">5</td><td>level_id</td><td>integer</td><td class="text-center">否</td><td>获奖等级ID</td><td>            <a href="/docs/model/std/award/scholarship.html#表格-scholarship_levels-奖学金等级">std.scholarship_levels</a>
</td>  </tr>
...
<tr><td class="text-center">11</td><td>scholarship_type_id</td><td>integer</td><td class="text-center">否</td><td>奖学金类型ID</td><td>            <a href="/docs/model/std/award/scholarship.html#表格-scholarship_types-奖学金类型">std.scholarship_types</a>
</td>  </tr>
</table>
  </div>
</div>
...
<tr><td class="text-center">3</td><td>category_id</td><td>integer</td><td class="text-center">否</td><td>奖学金种类ID</td><td>            <a href="/docs/model/std/award/scholarship.html#表格-scholarship_categories-奖学金种类">std.scholarship_categories</a>
</td>  </tr>
