...
<tr><td class="text-center">4</td><td>category_id</td><td>integer</td><td class="text-center">否</td><td>困难补助种类ID</td><td>            <a href="/docs/model/std/award/subsidy.html#表格-subsidy_categories-困难补助种类">std.subsidy_categories</a>
</td>  </tr>
<tr><td class="text-center">5</td><td>level_id</td><td>integer</td><td class="text-center">否</td><td>获奖等级ID</td><td>            <a href="/docs/model/std/award/subsidy.html#表格-subsidy_levels-困难补助等级">std.subsidy_levels</a>
</td>  </tr>
...
<tr><td class="text-center">3</td><td>category_id</td><td>integer</td><td class="text-center">否</td><td>困难补助种类ID</td><td>            <a href="/docs/model/std/award/subsidy.html#表格-subsidy_categories-困难补助种类">std.subsidy_categories</a>
</td>  </tr>
