...
<tr><td class="text-center">3</td><td>activity_type_id</td><td>integer</td><td class="text-center">否</td><td>活动类型ID</td><td>            <a href="/model/code/edu/all.html#表格-activity_types-活动类型">code.activity_types</a>
</td>  </tr>
...
<tr><td class="text-center">4</td><td>applicant_id</td><td>bigint</td><td class="text-center">否</td><td>借用人ID</td><td>            <a href="/model/base/common/user.html#表格-users-通用人员信息">base.users</a>
</td>  </tr>
